...
namespace TravelReview.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,FirstName,LastName,City,State,Comments,Ratings,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,FirstName,LastName,City,State,Comments,Ratings,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
